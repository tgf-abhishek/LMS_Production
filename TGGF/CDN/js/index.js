...
function websdkready() {
  ...
  var API_KEY = "CSf1oldkRsqpiYO8jna8EA";
   ...
   */
  var API_SECRET = "jVePmKWP097FiMZK5fMZpOikBZdeqZDFS71N";

  // some help code, remember mn, pwd, lang to cookie, and autofill.
  document.getElementById("display_name").value = "";
  document.getElementById("meeting_number").value = "88054354485";
  document.getElementById("meeting_pwd").value = "b3ZlYXA4VXl0WE44d1R3Y24xaXE2UT09";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/TGGF/CDN//meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
