...
$instance 	= $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'ccavenue'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/ccavenue/unenrolself.php', array('enrolid'=>$instance->id));
...
$message	= get_string('unenrolselfconfirm', 'enrol_ccavenue', format_string($course->fullname));
