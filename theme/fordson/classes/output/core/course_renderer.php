                        ...
                        if ($PAGE->theme->settings->coursetilestyle == 4) {
                           ...
                           $rowcontent .= '
                            ...
                            $rowcontent .= '
                                    ...
                                    <a href="' . $courseurl . '" id="mainlink">    
                                    <span style="display: flex; justify-content: flex-end;"><span class="w3-badge" style="background-color:#403d3d;">' . $i . '</span></span>           
                                    ...
                                    <a href="' . $courseurl . '" > 
                                    <div class="categdiv">
                                    <a><h5 style="color:white; pointer-events:none; font-size: 16px;" >'. $devcatname .'</h5></a>
                                    </div>
                                    </a>
                                    ...
                                    .class-box4{
                                        background: linear-gradient(#7232a1 0%,#7232a1 75%,#FFFFFF 75%,#FFFFFF 100% );
                                        border-radius: 10px;
                                        height: 250px;
